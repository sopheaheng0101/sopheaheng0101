...
### 1. Fast Invoice
* **Live App:** [fastinvoicekh.web.app](https://fastinvoicekh.web.app/)
* **Overview:** ប្រព័ន្ធបង្កើតវិក្កយបត្រឌីជីថល (Invoice Generator) ប្រកបដោយភាពរហ័ស និងងាយស្រួល ដែលត្រូវបានបង្កើតឡើងជាពិសេសដើម្បីជួយសម្រួលដល់ម្ចាស់អាជីវកម្មខ្នាតតូច មធ្យម (SMEs) អ្នកលក់អនឡាញ និងហ្វ្រែលែនស៍ (Freelancers) ក្នុងការរៀបចំវិក្កយបត្រជូនអតិថិជនដោយមិនបាច់ចំណាយពេលគណនាយូរ។ វាช่วยផ្តល់នូវភាពងាយស្រួល ភាពរហ័សទាន់ចិត្ត និងភាពអាជីព (Professional) ក្នុងការគ្រប់គ្រងកំណត់ត្រាទូទាត់ប្រាក់ផ្សេងៗ។
